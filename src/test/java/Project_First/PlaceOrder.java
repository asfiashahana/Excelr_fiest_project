...
public class PlaceOrder {
	...
	public void RegisterUser()
	{
		...
		driver.findElement(By.xpath("//p[@class='text-center']")).click();
		
		driver.findElement(By.xpath("//input[@type='text']")).sendKeys("shahana");
		driver.manage().timeouts().implicitlyWait(Duration.ofSeconds(10));
		driver.findElement(By.cssSelector("input[data-qa=\"signup-email\"]")).sendKeys("shahana@gmail.com");
		driver.findElement(By.cssSelector("button[data-qa=\"signup-button\"]")).click();
		 ...
		 Assert.assertTrue(driver.findElement(By.xpath("//b[contains(.,'Enter Account Information')]")).isDisplayed());
			...
			driver.findElement(By.id("first_name")).sendKeys("huma");
			driver.findElement(By.id("last_name")).sendKeys("hana");
